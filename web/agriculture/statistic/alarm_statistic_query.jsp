                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <input type="hidden" id="table_name" name="table_name" value="agriculture_alarm" />
                                            <input type="hidden" id="module_name" name="module_name" value="alarm" />
...
<script type="text/javascript" src="../../assets/scripts/agriculture/statistic/alarm_statistic_query.js"></script>

        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>模块权限管理 <small>模块权限统计</small></h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <input type="hidden" id="table_name" name="table_name" value="agriculture_tree" />
                                            <input type="hidden" id="module_name" name="module_name" value="modu" />
...
<script type="text/javascript" src="../../assets/scripts/agriculture/statistic/modu_statistic_query.js"></script>

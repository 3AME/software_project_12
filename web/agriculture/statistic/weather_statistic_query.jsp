                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <input type="hidden" id="table_name" name="table_name" value="agriculture_weather" />
                                            <input type="hidden" id="module_name" name="module_name" value="weather" />
...
<script type="text/javascript" src="../../assets/scripts/agriculture/statistic/weather_statistic_query.js"></script>

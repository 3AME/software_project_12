                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">地区<font color="red">*</font></label>
                                                <div class="col-md-9">
                                                    <input type="text" id="location" name="location" class="form-control" placeholder="请输入地区">
                                                </div>
                                            </div>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/weather/weather_query.js"></script>

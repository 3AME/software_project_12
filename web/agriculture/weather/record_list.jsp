...
<%
    ...
    String resultMsg=(String)session.getAttribute("agriculture_weather_message");
    session.setAttribute("agriculture_weather_message","noMessage");
...
<script type="text/javascript" src="../../assets/scripts/agriculture/weather/record_list.js"></script>

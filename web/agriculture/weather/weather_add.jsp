                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <input type="hidden" id="from_index" name="from_index" value="0"/>
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group date form_datetime">
                                                        <input type="text" id="update_time" name="update_time" class="form-control" size="16" placeholder="请输入更新时间" value=""/>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/weather/weather_add.js"></script>

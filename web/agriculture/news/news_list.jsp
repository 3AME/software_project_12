                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-toolbar">
                                ...
                                <%--<div class="btn-group" style="margin: 5px 0px 5px 0px;">--%>
                                    <%--<button id="getNews" class="btn green-meadow">--%>
                                        <%--显示新闻--%>
                                    <%--</button>--%>
                                <%--</div>--%>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-group form-control"  id="sort_01">
                                        ...
                                        <option value="news_name">按新闻名</option>
                                        <option value="register_time">按日期</option>
                                ...
                                <%--<div class="col-md-2">--%>
                                    <%--<select class="form-group form-control"  id="sort_03">--%>
                                        <%--<option value="null">请选择</option>--%>
                                        <%--<option value="user_name">按新闻名</option>--%>
                                        <%--<option value="register_time">按日期</option>--%>
                                        <%--<option value="role_id">按权限</option>--%>
                                    <%--</select>--%>
                                <%--</div>--%>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/news/news_list.js"></script>
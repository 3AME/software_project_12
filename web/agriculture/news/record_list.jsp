...
<%
    ...
    String resultMsg=(String)session.getAttribute("agriculture_news_message");
    session.setAttribute("agriculture_news_message","noMessage");
    ...
    else
    {
        ...
        //tip="下载导出文件："+"<a href=\""+"/pa/1.jpg"+"\" >"+"pa/1.jpg"+"</a>";
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-toolbar">
                                ...
                                <div class="btn-group" style="margin: 5px 0px 5px 0px;">
                                    <button id="addnews_button" class="btn green-meadow">
                                        增加新闻
                                    </button>
                                </div>
                                <div class="btn-group" style="margin: 5px 0px 5px 0px;">
...
<script type="text/javascript" src="../../assets/scripts/agriculture/news/record_list.js"></script>

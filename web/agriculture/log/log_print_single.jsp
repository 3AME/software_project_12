...
<div>
    ...
    <input type="button" class="no_print" value="返回" onclick=javascript:window.location.href="log_view.jsp?id=<%=id%>">
    ...
    var init = function() {
        ...
        $.post(url,function(json) {
            if (json.result_code == 0) {
                ...
                var colTime=json[1];
                var colContent=json[2];
                var colOperation=json[3];
                var colUserId=json[4];
                var colModule=json[5];
                var colSub=json[6];
                var ip=json[7];

                $("#col_time").val(colTime);
                $("#col_content").val(colContent);
                $("#col_operation").val(colOperation);
                $("#col_user_id").val(colUserId);
                $("#col_module").val(colModule);
                $("#col_sub").val(colSub);
                $("#ip").val(ip);
            }
        })

...
<%
    ...
    String resultMsg=(String)session.getAttribute("agriculture_log_message");
    session.setAttribute("agriculture_log_message","noMessage");
...
<script type="text/javascript" src="../../assets/scripts/agriculture/log/record_list.js"></script>

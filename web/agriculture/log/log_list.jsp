                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-group form-control"  id="sort_01">
                                        ...
                                        <option value="colOperation">按操作名</option>
                                        <option value="colUserId">按操作人</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
...
<script type="text/javascript" src="../../assets/scripts/agriculture/log/log_list.js"></script>

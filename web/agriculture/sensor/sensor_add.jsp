        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>传感器数据管理 <small>数据列表</small></h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="sensor_value_string" name="sensor_value_string"
                                                           class="form-control" placeholder="请输入具体数值" value=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group date form_datetime">
                                                        <input type="text" id="detect_time" name="detect_time" class="form-control" size="16" placeholder="请输入检测时间" value=""/>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/sensor/sensor_add.js"></script>

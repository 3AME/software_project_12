                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="device_id" name="device_id" class="form-control" placeholder="请填写名称">
                                                </div>
                                            </div>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/sensor/sensor_query.js"></script>

...
<%
    ...
    String resultMsg=(String)session.getAttribute("agriculture_sensor_message");
    session.setAttribute("agriculture_sensor_message","noMessage");
...
<script type="text/javascript" src="../../assets/scripts/agriculture/sensor/record_list.js"></script>

                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-group form-control"  id="sort_01">
                                        ...
                                        <option value="sensor_value_float">按数值大小</option>
                                        <option value="detect_Time">按检测时间</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
...
<script type="text/javascript" src="../../assets/scripts/agriculture/sensor/sensor_list.js"></script>
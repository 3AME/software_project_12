...
<%
    ...
    String resultMsg=(String)session.getAttribute("agriculture_users_message");
    session.setAttribute("agriculture_users_message","noMessage");
...
<script type="text/javascript" src="../../assets/scripts/agriculture/users/record_list.js"></script>

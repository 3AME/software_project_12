        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1>模块权限管理 <small>模块权限查询</small></h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="MODULE_NAME" name="MODULE_NAME" placeholder="请输入模块名" class="form-control"/>
                                                    <span class="help-block">将进行模糊查询 </span>
                                                </div>
                                            </div>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/modu/modu_query.js"></script>

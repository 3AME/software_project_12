...
<div>
    ...
    <input type="button" class="no_print" value="返回" onclick=javascript:window.location.href="modu_view.jsp?id=<%=id%>">
                    ...
                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="MODULE_NAME" name="MODULE_NAME" placeholder="请输入用户名" class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">目录id</label>
                                <div class="col-md-9">
                                    <input type="text" id="CATEGORY_ID" name="CATEGORY_ID" placeholder="请输入密码" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">父id</label>
                                <div class="col-md-9">
                                    <input type="text" id="PARENT_CATEGORY_ID" name="PARENT_CATEGORY_ID" placeholder="请输入邮箱" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">目录名</label>
                                <div class="col-md-9">
                                    <input type="text" id="FILE_PATH" name="FILE_PATH" placeholder="请输入密码" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">文件名</label>
                                <div class="col-md-9">
                                    <input type="text" id="HREFLINK" name="HREFLINK" placeholder="请输入邮箱" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">全id</label>
                                <div class="col-md-9">
                                    <input type="text" id="FILE_ID" name="FILE_ID" placeholder="请输入密码" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">模块名</label>
                                <div class="col-md-9">
                                    <input type="text" id="FILE_NAME" name="FILE_NAME" placeholder="请输入邮箱" class="form-control"/>
                                </div>
                            </div>
                        </div>

                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-group form-control"  id="sort_01">
                                        ...
                                        <option value="device_name">按设备名</option>
                                        <option value="register_time">按安装时间</option>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/device/device_list.js"></script>
...
<%
    ...
    String resultMsg=(String)session.getAttribute("agriculture_device_message");
    session.setAttribute("agriculture_device_message","noMessage");
...
<script type="text/javascript" src="../../assets/scripts/agriculture/device/record_list.js"></script>

...
<div>
    ...
    <input type="button" class="no_print" value="返回" onclick=javascript:window.location.href="device_view.jsp?id=<%=id%>">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group date form_datetime">
                                        <input type="text" id="limit_time" name="limit_time" class="form-control" size="16"  value=""/>
    ...
    var init = function() {
        ...
        $.post(url,function(json) {
            if (json.result_code == 0) {
                ...
                $("#device_price").val(device_price);
                $("#status").val(status);
                $("#limit_time").val(registerTime);
                $("#role_id").val(roleId);
            }
        })
    }

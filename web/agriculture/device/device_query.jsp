                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group date form_datetime">
                                                        ...
                                                        <input type="text" id="time_from" name="time_from" class="form-control" size="16" placeholder="请输入安装时间" value=""/>
                                                    ...
                                                    <span>到</span>
                                                    <div class="input-group date form_datetime">
                                                        <input type="text" id="time_to" name="time_to" class="form-control" size="16" placeholder="请输入安装时间" value=""/>
														<span class="input-group-btn">
															<button class="btn default date-set" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/device/device_query.js"></script>

                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">设备价格</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="device_price" name="device_price" placeholder="请输入设备价格" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">运行状态</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="status" name="status" placeholder="请输入设备运行状态" class="form-control"/>
                                                </div>
                                            </div>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/device/device_add.js"></script>

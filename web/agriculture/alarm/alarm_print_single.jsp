...
<div>
    ...
    <input type="button" class="no_print" value="返回" onclick=javascript:window.location.href="alarm_view.jsp?id=<%=id%>">
                    ...
                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="value_type" name="value_type" placeholder="请输入异常信息" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    var init = function() {
        ...
        $.post(url,function(json) {
            if (json.result_code == 0) {
                ...
                var valueString=json[1];

                var handleStatus=json[3];
                var sendStatus=json[4];
                var handleTime=json[5];
                var valueType=json[2];

                $("#value_string").val(valueString);
                $("#value_type").val(valueType);
                $("#handle_status").val(handleStatus);
                $("#send_status").val(sendStatus);
                $("#handle_time").val(handleTime);
            }
        })
    }

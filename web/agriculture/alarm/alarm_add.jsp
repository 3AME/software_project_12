                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="handle_status" name="handle_status" placeholder="请输入处理状态" class="form-control"/>
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="control-label col-md-3">提醒状态</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="send_status" name="send_status" placeholder="请输入提醒状态" class="form-control"/>
                                                </div>
                                            </div>
-->
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group date form_datetime">
                                                        <input type="text" id="handle_time" name="handle_time" class="form-control" size="16" placeholder="请输入处理时间" value=""/>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/alarm/alarm_add.js"></script>

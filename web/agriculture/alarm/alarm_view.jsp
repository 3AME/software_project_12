                                    ...
                                    <form action="#" class="form-horizontal form-row-seperated" id="page_form" name="page_form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">数值大小</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="value_string" name="value_string" placeholder="请输入数值大小" class="form-control"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="bs-select form-control" id="handle_status" name="handle_status">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">提醒状态</label>
                                                <div class="col-md-9">
                                                    <select class="bs-select form-control" id="send_status" name="send_status">
                                                        <option value="1">1</option>
                                                        <option value="0">0</option>
                                                    </select>
                                                </div>
...
<script type="text/javascript" src="../../assets/scripts/agriculture/alarm/alarm_view.js"></script>

    ...
    var N = function(h) {
        ...
        function Da(a) {
            ...
            for (f = b.length; e < f; e++)
                ...
                g = 0;
                for (j = d.length; g < j; g++) { i = 0; for (h = c.length; i < h && !(k[i] === l && (k[i] = A(a, i, e, "type")), o = d[g](k[i], a), !o || "html" === o); i++); if (o) { m.sType = o; break } }
        ...
        function U(a) {
            if (h.isPlainObject(a)) {
                ...
                return function(a, c, f, g) { var j = b[c] || b._; return j !== l ? j(a, c, f, g) : a }
            }
        ...
        function la(a, b, c, d) {
            ...
            else { c = 0; for (f = a.length; c < f; c++) a[c].sType = null }
            Ia(e)
        }
            ...
            for (var f = a.sDom.split(""), g, j, i, n, m, o, k = 0; k < f.length; k++) {
                ...
                if ("<" == j) {
                    ...
                    for (n = i.length; o < n; o++)
                        if (j == i[o].cFeature) { g = i[o].fnInit(a); break }
                }
        ...
        function Na(a, b, c, d) {
            a = b ? a : Oa(a);
            c && (a = "^(?=.*?" + h.map(a.match(/"[^"]+"|[^ ]+/g) || "", function(a) { return '"' === a.charAt(0) ? a.match(/^"(.*)"$/)[1] : a }).join(")(?=.*?") + ").*$");
            return RegExp(a, d ? "i" : "")
        }
        ...
        p = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) P(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (r.length) {
                        var s = function(a, b) { return a.getAttribute("data-" + b) ? b : null };
                ...
                if (null === b || b === l) return this.iterator("table", function(b) {
                    ...
                    return Za(d, function(a) {
                        if (a === null || a === l) {
                            n = [];
                            p = 0;
                            for (r = g.length; p < r; p++) { i = g[p]; for (q = 0; q < m; q++) n.push({ row: i, column: q }) }
                            return n
                        }

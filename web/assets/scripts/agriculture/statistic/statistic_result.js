...
var Record = function() {
    ...
    var showStatisticImage=function(imageFile){
        //$("#result_image").attr("src","//chart/"+imageFile+"?"+Math.random());
        $("#result_image").attr("src","../../../"+imageFile+"?"+Math.random());//注意
    }
...
var ChartsFlotcharts = function() {
    ...
    var initBarCharts=function(data) {//data传入的是aaData
        if (data == undefined)
        {//初始化时先用默认数据
            data = [{
                "year": 2009,
        ...
        var chart = AmCharts.makeChart("result_image", {//图表id
            "type": "serial",
            "theme": "light",

...
/*================================================================================*/
//var show=function(){
//    var url="https://www.jisuapi.com/api/news/";
//    console.log(url);
...
var Page = function() {
    ...
    //var getNews;
    //getNews = function () {
    //    var newurl = "https://www.jisuapi.com/api/news";
    ...
    var handleButtonEvent=function(){
        ...
        //$('#getNews').click(function() {Page.getNews()});
    };
    ...
    var showRecord = function(json){
        ...
        html=html+"                                                <p>新闻名："+userName+"</p>";
        html=html+"                                                <p>内容："+password+"</p>";
        html=html+"                                                <p>邮箱："+email+"</p>";
        html=html+"                                                <p>注册时间："+registerTime+"</p>";
        html=html+"                                            </div>";

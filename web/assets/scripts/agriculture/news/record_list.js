...
var Record = function() {
    ...
    var exportRecord=function(){//也可以post，json返回url？
...
var Page = function() {
    ...
    var handleButtonEvent=function(){
        ...
        $('#addnews_button').click(function() {Page.getRequest1();});
...
//        var URL="http://v.juhe.cn/toutiao/index?key=7f2a21548ca5f12ae441512124b8a581";
//        var result="";
//        var newsname="";
//        var register_time="";
//        var newsurl="";
...
//                //    console.log("error");
//                //}
//                console.log("json of news is "+JSON.stringify(json));
//                var newsJson=json.Data;
//                handleNewsJson(newsJson);
//            });
//        };
//        var jump=function(){
//            window.location.href="../../agriculture/news/news_list.jsp";
//        }
//        var handleNewsJson=function(json){
////            var resultjson =json[0].result;
//            var datajson=json[0].data;
//
//            //          location=resultjson.data;
//            newsname=datajson.title;
//            register_time=datajson.date;
//            newsurl=datajson.url;
//        };
//
//        var addNewsRecord = function(){
//            var url="../../agriculture_news_servlet_action?action=add_record"+
//                "&result="+result+
//                "&newsname="+newsname+
//                "&register_time="+register_time+
//                "&newsurl="+newsurl;
//
//            console.log("url in addNewsRecord is " + url);
//            $.post(url, function (json) {
//                if (json.result_code == 0) {
//                } else {
//                    alert("Error in addNewsRecord!!!!");
//                }

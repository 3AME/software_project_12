...
var Page = function() {
    ...
    var showRecord = function(json){
        ...
        html=html+"                                                <p>数值大小："+valueString+"</p>";
        html=html+"                                                <p>数据类型："+valueType+"</p>";
        html=html+"                                                <p>处理状态："+handleStatus+"</p>";
        html=html+"                                                <p>提醒状态："+sendStatus+"</p>";
        html=html+"                                                <p>处理时间："+handleTime+"</p>";
    ...
    var sortRecord=function(){//Page里的函数处理排序规则，传给Record里的函数
        ...
        console.log("sortName in alarm list is "+sortName);

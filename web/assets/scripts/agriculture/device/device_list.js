...
var Page = function() {
    ...
    var showRecord = function(json){
        ...
        var userName=json[1];
        var device_type=json[2];
        var device_price=json[3];
        ...
        html=html+"                                                <p>设备名："+userName+"</p>";
        html=html+"                                                <p>设备类型："+device_type+"</p>";
        html=html+"                                                <p>设备单价："+device_price+"</p>";
        html=html+"                                                <p>设备状态："+status+"</p>";
        html=html+"                                                <p>安装时间："+registerTime+"</p>";
        html=html+"                                            </div>";

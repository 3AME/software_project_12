...
var Page = function() {
    ...
    var showRecord = function(json){
        ...
        html=html+"                                                <p>模块名（带编号）："+moduleName+"</p>";
        html=html+"                                                <p>权限："+roleId+"</p>";
        html=html+"                                                <p>id号："+categoryId+"</p>";
        html=html+"                                                <p>父id号："+parentCategoryId+"</p>";
        html=html+"                                                <p>目录名："+filePath+"</p>";
        html=html+"                                                <p>文件名："+hreflink+"</p>";
        html=html+"                                                <p>全id号："+fileId+"</p>";
        html=html+"                                                <p>模块名："+fileName+"</p>";
        html=html+"                                            </div>";

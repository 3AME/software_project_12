...
var Record = function() {
    ...
    var getRecord = function(){
        ...
        console.log("url in getRecord in weather_list is "+url);
...
var Page = function() {
    ...
    var showRecord = function(json){
        ...
        html=html+"                                                <img src=\"../../assets/admin/pages/media/gallery/image4.jpg\" alt=\"\">";
        html=html+"                                            </div>";
        html=html+"                                            <div class=\"booking-info\" style=\"overflow:hidden;\">";
        html=html+"                                                <p>地区："+location+"</p>";
        html=html+"                                                <p>天气详情："+detailString+"</p>";
        html=html+"                                                <p>温度："+tempString+"</p>";
        html=html+"                                                <p>风向："+windDirection+"</p>";
        html=html+"                                                <p>风力："+windForce+"</p>";
        html=html+"                                                <p>湿度："+humidityString+"</p>";
        html=html+"                                                <p>大气压强："+pressureString+"</p>";
        html=html+"                                                <p>降水量："+precipitatiString+"</p>";
        html=html+"                                                <p>更新时间："+updateTime+"</p>";
        html=html+"                                            </div>";

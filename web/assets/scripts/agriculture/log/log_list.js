...
var Record = function() {
    ...
    var getRecord = function(){
        ...
        var url="../../"+module+"_"+sub+"_servlet_action?action=get_record&exist_resultset="+existResultset;
    ...
    var sortRecord=function(sortName){
        ...
        var url="../../"+module+"_"+sub+"_servlet_action?action=get_record&order_by="+sortName;
        console.log(url);
        $.post(url,function(json){
...
var Page = function() {
    ...
    var showRecord = function(json){
        ...
        html=html+"                                                <p>时间："+colTime+"</p>";
        html=html+"                                                <p>内容："+colContent+"</p>";
        html=html+"                                                <p>操作："+colOperation+"</p>";
        html=html+"                                                <p>操作者："+colUserId+"</p>";
        html=html+"                                                <p>项目："+colModule+"</p>";
        html=html+"                                                <p>子模块："+colSub+"</p>";
        html=html+"                                                <p>IP地址："+ip+"</p>";
        html=html+"                                            </div>";
    ...
    var sortRecord=function(){//Page里的函数处理排序规则，传给Record里的函数
        ...
        sortName=$("#sort_01").val()+","+$("#sort_02").val();//register_time,user_name,role_id

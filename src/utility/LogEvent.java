...
public class LogEvent {
	...
	public void log(String msg, String operation) {
		log(msg, operation,"security",null);
	}
	public void log(String msg, String operation,String module,String sub) {
		String time = "";
		...
		try {
			...
			DB log_db = new DB((String) session.getAttribute("unit_db_name"));
			String sql = "insert into public_log(colTime,colType,colContent,colOperation,colUserId,colModule,colSub,ip,create_time) " +
                    "values(" + "'" + time + "'" + "," + type + "" + ",'" + msg + "'" + ",'" + operation + "'" + ",'" + operator + "'" + ",'"+module+"'"+",'"+sub+"'"+",'"+ip+"'"+ "," + "'" + time + "'" +")";

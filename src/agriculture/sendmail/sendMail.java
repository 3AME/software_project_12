package agriculture.sendmail;

/**
 * Created by anfan on 2019/6/30.
 */
...
public class sendMail {
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "lafhhh@outlook.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setContent("anfang用户你好,你的密码被重置为1234567", "text/html;charset=UTF-8");
